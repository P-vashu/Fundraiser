  ...
  return (
    <>
      <div className="text-white gap-4 flex flex-col justify-center items-center h-[44vh]">
        <div className="font-bold text-5xl flex gap-2 justify-center items-baseline">Buy Me A Chai <span><Image src="/chai1.gif" alt="Not showing" width={44} /></span></div>
      ...
      <div className="text-white container mx-auto pb-32 pt-14">
        ...
        <div className="flex gap-5 justify-around">
          <div className="item space-y-3 flex flex-col justify-center items-center">
            <Image className="bg-slate-400 rounded-full p-6" src="/man1.png" alt="" width={140} />
            <p className="font-bold">Fund yourself</p>
            <p>Your fans are availabel for you to help</p>
          </div>
          <div className="item space-y-3 flex flex-col justify-center items-center">
            <Image className="bg-slate-400 rounded-full p-0" src="/coin2.gif" alt="" width={150} />
            <p className="font-bold">Fund yourself</p>
            <p>Your fans are availabel for you to help</p>
          </div>
          <div className="item space-y-3 flex flex-col justify-center items-center">
            <Image className="bg-slate-400 rounded-full p-2" src="/people.png" alt="" width={140} />
