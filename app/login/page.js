    ...
    return (
        <>
            <div className='text-white py-14 container mx-auto'>
                <h1 className='text-center text-3xl font-bold'>Login/SignUp to get your fans Support</h1>
            </div>
            <div className='social-login-buttons'>
                <div className="flex flex-col gap-2 min-h-screen items-center">

                    <button onClick={()=>signIn("google")}
                        className="flex items-center w-60 bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
